...
export default () => {
  ...
  const carouselItems = [
    ...
    },
    {
      id: 2,
      title: 'Title 2',
      content: 'Duis magna et irure proident ea aliqua aliqua culpa proident est velit laboris laboris velit. Sunt excepteur in incididunt ullamco cillum aute ut. Incididunt nulla eu sit Lorem incididunt.',
      linkURL: '#',
      linkCaption: '¡LO QUIERO YA!',
